...
export class DonateNowComponent extends React.Component<IDonateNowComponentProps,{}>{
    private _donationType : DonationType = DonationType.Individual;
    private controller : DonationController;
    ...
    handleDontationTypeSelection = (id:number) => {
        switch(id){
            case 1:
                this._donationType = DonationType.Individual;
                break;
            case 2:
                this._donationType = DonationType.Organisation;
                break;
            case 3:
                this._donationType = DonationType.Other;
                break;
        }
    }   
                                ...
                                <div className="form-group">
                                    ...
                                    <div>
                                        <select ref="needs" className="form-control" id="needs" defaultValue={causeId} >
                                            ...
                                            <option value="1">Please help us with Need 1</option>
                                            <option value="2">Please help us with Need 2</option>
                                            <option value="3">Please help us with Need 3</option>                                              
                                        </select>
                                    </div>
                                </div>
