                            ...
                            <div id="donate">                                    
                                ...
                                <fieldset className="tab-content">
                                    ...
                                    <div className="tab-pane fade " id="notifications">								
                                        <div className="list-group">
                                            <a href="#" className="list-group-item"><span className="badge">0</span>Job Requests approved</a>
                                            <a href="#" className="list-group-item"><span className="badge">0</span>Job Requests pending</a>
                                            <a href="#" className="list-group-item"><span className="badge">0</span>Job Requests cancelled</a>
                                        </div>
                                    </div>                                
                                </fieldset>     
                            </div>  
